...
class Range
    ...
    class Iterator
        ...
        function next()
            var newIter = new Iterator(this.current + this.step, this.end, this.step)
            return newIter
        end
    end
    
    function begin()
        return new Iterator(this.start, this.end, this.step)
    end
    
    function end()
        return new Iterator(this.end, this.end, this.step)
    end
end
